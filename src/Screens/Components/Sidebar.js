        ...
        <aside className="navbar-aside" id="offcanvas_aside">
            <div className="aside-top">
                <a href="./" className="brand-wrap">
                    <img src="assets/imgs/theme/logo.png" className="logo" alt="Amuruth Dashboard" />
                </a>
                <div>
            ...
            <nav>
                <ul className="menu-aside">
                    ...
                    <li className="menu-item">
                        <a className="menu-link" href="./add-category">
                            <i className="icon material-icons md-add_box"></i>
                            <span className="text">Add Category</span>
                        </a>
                    </li>
                    <li className="menu-item">
                        <a className="menu-link" href="./add-product">
                            <i className="icon material-icons md-add_box"></i>
                            <span className="text">Add Product</span>
                        </a>
                    </li>
                    <li className="menu-item">
                        <a className="menu-link" href="./products-list">
                            <i className="icon material-icons md-shopping_bag"></i>
                            <span className="text">Products List</span>
                        </a>
                    </li>

                    <li className="menu-item">
                        <a className="menu-link" href="./orders-list">
                    ...
                    <li className="menu-item">
                        <a className="menu-link" href="/brands"> <i className="icon material-icons md-stars"></i> <span className="text">Brands</span> </a>
                    </li>
                    ...
                    <li className="menu-item">
                        <a className="menu-link" href="page-brands.html"> <i className="icon material-icons md-stars"></i> <span className="text">Brands</span> </a>
                    </li>
                    <li className="menu-item">
