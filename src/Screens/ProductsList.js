                        ...
                        <article className="itemlist">
                            <div className="row align-items-center">
                                ...
                                <div className="col-lg-4 col-sm-4 col-8 flex-grow-1 col-name">
                                    <a className="itemside" href="#">
                                        <div className="left">
                                            <img src="assets/imgs/items/3.jpg" className="img-sm img-thumbnail" alt="Item" />
                                        </div>
                                        <div className="info">
                                ...
                                <div className="col-lg-2 col-sm-2 col-4 col-status">
                                    <span className="badge rounded-pill alert-warning">Archived</span>
                                </div>
                                <div className="col-lg-1 col-sm-2 col-4 col-date">
                                    <span>02.11.2021</span>
                                </div>
                        ...
                        <article className="itemlist">
                            <div className="row align-items-center">
                                ...
                                <div className="col-lg-4 col-sm-4 col-8 flex-grow-1 col-name">
                                    <a className="itemside" href="#">
                                        <div className="left">
                                            <img src="assets/imgs/items/4.jpg" className="img-sm img-thumbnail" alt="Item" />
                                        </div>
                                        <div className="info">
                                            <h6 className="mb-0">Foster Farms Takeout Crispy classNameic Buffalo</h6>
                                        </div>
                                    </a>
                                </div>
                            ...
                            <div className="row align-items-center">
                                ...
                                <div className="col-lg-4 col-sm-4 col-8 flex-grow-1 col-name">
                                    <a className="itemside" href="#">
                                        ...
                                        <div className="info">
                                            <h6 className="mb-0">Blue Diamond Almonds Lightly Salted</h6>
                                        </div>
                                    </a>
                                </div>
                                <div className="col-lg-2 col-sm-2 col-4 col-price"><span>$76.99</span></div>
                        ...
                        <article className="itemlist">
                            <div className="row align-items-center">
                                ...
                                <div className="col-lg-4 col-sm-4 col-8 flex-grow-1 col-name">
                                    <a className="itemside" href="#">
                                        <div className="left">
                                            <img src="assets/imgs/items/5.jpg" className="img-sm img-thumbnail" alt="Item" />
                                        </div>
                                        <div className="info">
                                            <h6 className="mb-0">Chobani Complete Vanilla Greek Yogurt</h6>
                                        </div>
                                    </a>
                                </div>
                                <div className="col-lg-2 col-sm-2 col-4 col-price"><span>$18.00</span></div>
                        ...
                        <article className="itemlist">
                            <div className="row align-items-center">
                                ...
                                <div className="col-lg-4 col-sm-4 col-8 flex-grow-1 col-name">
                                    <a className="itemside" href="#">
                                        <div className="left">
                                            <img src="assets/imgs/items/6.jpg" className="img-sm img-thumbnail" alt="Item" />
                                        </div>
                                        <div className="info">
