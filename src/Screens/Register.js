                    ...
                    <div className="card-body">
                        ...
                        <form>
                            ...
                            <div className="mb-3">
                                ...
                                <div className="row gx-2">
                                    <div className="col-4"><input className="form-control" value="+998" type="text" /></div>
                                    <div className="col-8"><input className="form-control" placeholder="Phone" type="text" /></div>
                                </div>
                            </div>
                            <div className="mb-3">
                        ...
                        {/* <div className="d-flex gap-2 mb-4">
                            <a href="#" className="w-50 btn btn-light font-sm">
                                <svg aria-hidden="true" className="icon-svg" style="vertical-align: bottom; margin-top: -4px" width="20" height="20" viewBox="0 0 20 20">
                        ...
                        <p className="text-center mb-2">Already have an account? <a href="/login">Sign in now</a></p>
                    </div>
                </div>
            </section>
        </main>
